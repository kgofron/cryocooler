...
static const char * const deviceSupportNames[100] = {
    "devAaiSoft",
    "devaaiStream",
    "devAaoSoft",
    "devaaoStream",
...
static const dset * const devsl[100] = {
...
int cc_registerRecordDeviceDriver(DBBASE *pbase)
{
    ...
    registerDevices(pbase, 100, deviceSupportNames, devsl);
...
static const iocshFuncDef registerRecordDeviceDriverFuncDef =
                {"cc_registerRecordDeviceDriver",1,registerRecordDeviceDriverArgs};
