...
/* Generated from ../O.Common/cc.dbd */
...
epicsShareExtern dset *pvar_dset_devAaiSoft, *pvar_dset_devaaiStream,
    ...
    *pvar_dset_devAiStats, *pvar_dset_devAiClusts, *pvar_dset_devaiStream,
    ...
    *pvar_dset_devCasterMBBIState, *pvar_dset_asynMbbiInt32,
    ...
    *pvar_dset_devSiEnviron, *pvar_dset_devCasterSIMsg,
...
static const char * const deviceSupportNames[] = {
    ...
    "devAiStats", "devAiClusts", "devaiStream", "devAoSoft",
    "devAoSoftRaw", "devAoSoftCallback", "asynAoInt32", "asynAoFloat64",
    "devAoStats", "devaoStream", "asynRecordDevice", "devBiSoft",
    ...
    "asynLoUInt32Digital", "devlongoutStream", "devLsiSoft",
    "devLsiEnviron", "devlsiStream", "devLsoSoft", "devLsoSoftCallback",
    "devLsoStdio", "devlsoStream", "devMbbiSoft", "devMbbiSoftRaw",
    "devMbbiSoftCallback", "devCasterMBBIState", "asynMbbiInt32",
    "asynMbbiUInt32Digital", "devmbbiStream", "devMbbiDirectSoft",
    "devMbbiDirectSoftRaw", "devMbbiDirectSoftCallback",
    "asynMbbiDirectUInt32Digital", "devmbbiDirectStream", "devMbboSoft",
    "devMbboSoftRaw", "devMbboSoftCallback", "asynMbboInt32",
    "asynMbboUInt32Digital", "devmbboStream", "devMbboDirectSoft",
    "devMbboDirectSoftRaw", "devMbboDirectSoftCallback",
    "asynMbboDirectUInt32Digital", "devmbboDirectStream", "devPrintfSoft",
    ...
    "devCasterSIMsg", "asynSiOctetCmdResponse", "asynSiOctetWriteRead",
    "asynSiOctetRead", "devStringinStats", "devStringinEnvVar",
    "devStringinEpics", "devstringinStream", "devSoSoft",
...
static const dset * const devsl[] = {
    ...
    pvar_dset_devAiClusts, pvar_dset_devaiStream, pvar_dset_devAoSoft,
    pvar_dset_devAoSoftRaw, pvar_dset_devAoSoftCallback,
    pvar_dset_asynAoInt32, pvar_dset_asynAoFloat64, pvar_dset_devAoStats,
    pvar_dset_devaoStream, pvar_dset_asynRecordDevice,
    pvar_dset_devBiSoft, pvar_dset_devBiSoftRaw,
    pvar_dset_devBiSoftCallback, pvar_dset_devBiDbState,
    pvar_dset_asynBiInt32, pvar_dset_asynBiUInt32Digital,
    ...
    pvar_dset_devLoSoftCallback, pvar_dset_asynLoInt32,
    pvar_dset_asynLoUInt32Digital, pvar_dset_devlongoutStream,
    pvar_dset_devLsiSoft, pvar_dset_devLsiEnviron, pvar_dset_devlsiStream,
    pvar_dset_devLsoSoft, pvar_dset_devLsoSoftCallback,
    pvar_dset_devLsoStdio, pvar_dset_devlsoStream, pvar_dset_devMbbiSoft,
    pvar_dset_devMbbiSoftRaw, pvar_dset_devMbbiSoftCallback,
    pvar_dset_devCasterMBBIState, pvar_dset_asynMbbiInt32,
    pvar_dset_asynMbbiUInt32Digital, pvar_dset_devmbbiStream,
    pvar_dset_devMbbiDirectSoft, pvar_dset_devMbbiDirectSoftRaw,
    ...
    pvar_dset_devCasterSIMsg, pvar_dset_asynSiOctetCmdResponse,
    pvar_dset_asynSiOctetWriteRead, pvar_dset_asynSiOctetRead,
    pvar_dset_devStringinStats, pvar_dset_devStringinEnvVar,
    pvar_dset_devStringinEpics, pvar_dset_devstringinStream,
...
epicsShareExtern reg_func pvar_func_AsynDriverInterfaceRegistrar,
    ...
    pvar_func_dbrestoreRegister, pvar_func_drvAsynIPPortRegisterCommands,
    ...
    pvar_func_reccasterRegistrar, pvar_func_save_restoreRegister,
...
epicsShareExtern double * const pvar_double_reccastMaxHoldoff;
epicsShareExtern double * const pvar_double_reccastTimeout;
...
static struct iocshVarDef vardefs[] = {
    ...
    {"reccastMaxHoldoff", iocshArgDouble, pvar_double_reccastMaxHoldoff},
    {"reccastTimeout", iocshArgDouble, pvar_double_reccastTimeout},
...
int cc_registerRecordDeviceDriver(DBBASE *pbase)
{
    static int executed = 0;
    const char *bldTop = "/epics/iocs/cryo";
...
/* cc_registerRecordDeviceDriver */
static const iocshArg rrddArg0 = {"pdbbase", iocshArgPdbbase};
static const iocshArg *rrddArgs[] = {&rrddArg0};
static const iocshFuncDef rrddFuncDef =
    {"cc_registerRecordDeviceDriver", 1, rrddArgs};
static void rrddCallFunc(const iocshArgBuf *)
{
    cc_registerRecordDeviceDriver(*iocshPpdbbase);
}
