...
epicsShareExtern dset *pvar_dset_devAaiSoft, *pvar_dset_devaaiStream,
    ...
    *pvar_dset_devAoStats, *pvar_dset_devaoStream,
...
static const char * const deviceSupportNames[] = {
    ...
    "asynAiInt64", "devAiStats", "devAiClusts", "devaiStream",
    "devAoSoft", "devAoSoftRaw", "devAoSoftCallback", "asynAoInt32",
    "asynAoFloat64", "asynAoInt64", "devAoStats", "devaoStream",
    ...
    "devSiEnviron", "devCasterSIMsg", "asynSiOctetCmdResponse",
    "asynSiOctetWriteRead", "asynSiOctetRead", "devStringinStats",
    "devStringinEnvVar", "devStringinEpics", "devstringinStream",
...
static const dset * const devsl[] = {
    ...
    pvar_dset_devMbbiSoftCallback, pvar_dset_devCasterMBBIState,
...
epicsShareExtern reg_func pvar_func_AsynDriverInterfaceRegistrar,
    ...
    pvar_func_reccasterRegistrar, pvar_func_rsrvRegistrar,
    pvar_func_save_restoreRegister, pvar_func_streamRegistrar,
...
int cc_registerRecordDeviceDriver(DBBASE *pbase)
{
    ...
    runRegistrarOnce(pvar_func_reccasterRegistrar);
...
{
    iocshSetError(cc_registerRecordDeviceDriver(*iocshPpdbbase));
}
